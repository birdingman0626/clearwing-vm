...
/**
 * Comprehensive test suite for JDK 8 features in Clearwing VM.
 * Tests all major JDK 8 features including lambdas, streams, functional interfaces, 
 * default methods, Optional, and method references.
 */
class JDK8ComprehensiveTest {

    @Test
    @DisplayName("Lambda Expressions Work")
    ...
    @Test
    @DisplayName("Method References Work")
    ...
    @Test
    @DisplayName("Stream API Complex Pipeline Works")
    ...
    @Test
    @DisplayName("Optional API Works")
    void testOptional() {
    ...
    @Test
    @DisplayName("Functional Interfaces Work")
    ...
    @Test
    @DisplayName("Default Methods Work")
    ...
    void testStreamGrouping() {
        ...
        assertTrue(partitioned.get(false).contains("lambda"));
    }
    ...
    @Test
    @DisplayName("Stream FlatMap Works")
    ...
    void testStreamPeek() {
        ...
        assertEquals(Arrays.asList(1, 2, 3, 4, 5), peeked);
        assertEquals(Arrays.asList(2, 4, 6, 8, 10), result);
    }

    @Test
    @DisplayName("Stream Min and Max Work")
